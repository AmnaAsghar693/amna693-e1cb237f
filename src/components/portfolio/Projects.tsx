      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div ref={ref} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {PROJECTS.map((p, i) => (
            ...
            >
              <div className="relative h-44 flex items-center overflow-hidden justify-center" style={{ background: p.gradient }}>
                <i className={`${p.icon} text-5xl text-white/90 drop-shadow-lg`} />
                <img src={p.image} className="" />
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="mt-5 flex gap-3">
                  <a href={p.link1}  target="_blank" className="flex-1 text-center btn-outline-glow py-2 rounded-md text-sm inline-flex items-center justify-center gap-2">
                    <i className="fa-brands fa-github" /> GitHub
                  </a>
                  <a href={p.link2} target="_blank" className="flex-1 text-center btn-primary-glow py-2 rounded-md text-sm inline-flex items-center justify-center gap-2">
