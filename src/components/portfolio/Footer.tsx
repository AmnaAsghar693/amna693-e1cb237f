...
export function Footer() {
  ...
  return (
    <footer className="relative pt-0 pb-8 bg-[#0a0d12] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 text-center">
        ...
        <div className="mt-0 h-px w-full" style={{ background: "linear-gradient(90deg, transparent, rgba(110,64,201,0.5), rgba(0,212,255,0.5), transparent)" }} />
